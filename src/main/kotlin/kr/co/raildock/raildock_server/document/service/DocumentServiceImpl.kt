...
class DocumentServiceImpl(
    ...
    override fun getDocuments(): List<DocumentSummaryDto> {
    ...
    ========================= */
    @Transactional(readOnly = true)
    override fun getDocumentDetail(documentId: UUID): DocumentDetailDto {
    ...
    ========================= */
    @Transactional
    override fun createDocument(request: DocumentCreateRequest): UUID {
    ...
    override fun addRevision(
        ...
        val nextVersion = document.latestVersion + 1
